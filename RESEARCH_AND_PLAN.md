...
| **Linux**          | ❌ No official | -             | -           | -                     | -                           |
| **Linux (Snap)**   | ⚠️ Unofficial  | Basic wrapper | ✅ Basic    | chat.qwen.ai          | `qwen-desktop` on Snapcraft |
| **Linux (GitHub)** | ⚠️ Unofficial  | Electron      | ❌ No       | chat.qwen.ai          | `lisniuse/qwen-desktop`     |
...
- **Source:** Not公开 (no source code link)
...
### Reference Implementation (from 掘金 article)
...
- [掘金: Electron + MCP Guide](https://juejin.cn/post/7600430748781346859)
- [掘金: MCP Chat Room](https://juejin.cn/post/7487813517548159003)
